...
namespace chess
{
	...
	void PrintGameInformation(std::istream &is, std::ostream &os)
	{
		...
		int blackScore = 100 * pieceCounter[BLACK][PAWN] + 320 * pieceCounter[BLACK][KNIGHT] + 330 * pieceCounter[BLACK][BISHOP] + 500 * pieceCounter[BLACK][ROOK] + 900 * pieceCounter[BLACK][QUEEN] + 20000 * pieceCounter[BLACK][KING];
		int whiteScore = 100 * pieceCounter[WHITE][PAWN] + 320 * pieceCounter[WHITE][KNIGHT] + 330 * pieceCounter[WHITE][BISHOP] + 500 * pieceCounter[WHITE][ROOK] + 900 * pieceCounter[WHITE][QUEEN] + 20000 * pieceCounter[WHITE][KING];
	...
	constexpr bool IsValidPiece(char piece)
	{
		return (piece == 'p' || piece == 'P' || piece == 'n' || piece == 'N' || piece == 'b' || piece == 'B' || piece == 'r' || piece == 'R' || piece == 'q' || piece == 'Q' || piece == 'k' || piece == 'K');
	}
